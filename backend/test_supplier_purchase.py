...
# -*- coding: utf-8 -*-
"""
اختبار محاسبة فواتير الشراء من مورد
...
def test_supplier_purchase():
    """إنشاء فاتورة شراء من مورد واختبار القيود المحاسبية"""
    
    print("=" * 80)
    print("🧪 اختبار فاتورة شراء من مورد")
    print("=" * 80)
    ...
    print(f"\n📋 ملخص النتائج:")
    print(f"   - تم إنشاء فاتورة شراء من مورد #{invoice_id}")
