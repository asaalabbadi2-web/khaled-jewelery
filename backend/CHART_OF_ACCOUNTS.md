...
- **1290** - مخزون ألماس
- **1300** - مخزون أحجار كريمة (تحذير: سيتعارض مع السلف - استخدم 1290 بدلاً منه)
...
- **120 - المخزون**
  ...
  - *(يمكن إضافة أنواع مخزون من 1290)*
...
- **140 - السلف والودائع قصيرة الأجل**
  - 1400 - سلف موظفين (حساب تجميعي)
    - **نطاق السلف التفصيلية: 140000 - 149999** (سعة 10,000 سلفة)
    - مثال: 140000 (سلفة الموظف الأول), 140001 (سلفة الموظف الثاني)...
    - **الربط:** كل حساب سلفة مرتبط بحساب الموظف (130xxx)
  - 1410 - تأمينات مستردة
