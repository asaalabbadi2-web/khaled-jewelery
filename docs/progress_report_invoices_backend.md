...
| 5 | شراء | `'شراء'` | شراء ذهب من المورد | Accounting |
| 6 | مرتجع شراء للمورد | `'مرتجع شراء (مورد)'` | إرجاع ذهب للمورد | Accounting |
...
def create_invoice():
    ...
    if data['invoice_type'] in ['مرتجع بيع', 'مرتجع شراء', 'مرتجع شراء (مورد)']:
